...
type
  Tfrm_ProveedoresCont = class(TForm)
...
var
  frm_ProveedoresCont: Tfrm_ProveedoresCont;
...
procedure Tfrm_ProveedoresCont.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  action := cafree ;
end;

procedure Tfrm_ProveedoresCont.FormKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure Tfrm_ProveedoresCont.FormShow(Sender: TObject);
begin
    zQProveedores.Active := False ;
    zQProveedores.Open ;
end;

procedure Tfrm_ProveedoresCont.frmBarra1btnAddClick(Sender: TObject);
begin
...
procedure Tfrm_ProveedoresCont.frmBarra1btnCancelClick(Sender: TObject);
begin
  frmBarra1.btnCancelClick(Sender);
  zqProveedores.Cancel
end;

procedure Tfrm_ProveedoresCont.frmBarra1btnDeleteClick(Sender: TObject);
begin
...
If zQProveedores.RecordCount  > 0 then
    ...
    begin
      try
         ...
         Connection.QryBusca.SQL.Add('Select sIdProveedor from con_tesoreriapegresos Where sIdProveedor =:Proveedor');
...
procedure Tfrm_ProveedoresCont.frmBarra1btnEditClick(Sender: TObject);
begin
...
procedure Tfrm_ProveedoresCont.frmBarra1btnExitClick(Sender: TObject);
begin
//  zQProveedores.Post ;
...
procedure Tfrm_ProveedoresCont.frmBarra1btnPostClick(Sender: TObject);
begin
  frmBarra1.btnPostClick(Sender);
end;

procedure Tfrm_ProveedoresCont.zQProveedoresAfterInsert(
  DataSet: TDataSet);
begin
