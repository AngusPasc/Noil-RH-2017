object frmNominaRegimenes: TfrmNominaRegimenes
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'R'#233'gimenes de Personal'
  ClientHeight = 246
  ClientWidth = 478
  Color = clBtnFace
  ...
  object grid_Comunidades: TDBGrid
    ...
    Color = clWhite
    Ctl3D = False
    DataSource = ds_RegimenesPersonal
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -11
    Font.Name = 'Arial'
  ...
  object ds_RegimenesPersonal: TDataSource
    AutoEdit = False
    DataSet = zq_RegimenesPersonal
    Left = 115
    Top = 49
  end
  object zq_RegimenesPersonal: TZQuery
    Connection = connection.zConnection
    SQL.Strings = (
      'SELECT * FROM nom_regimenesempleados;')
    Params = <>
    Left = 80
    Top = 48
    object zq_RegimenesPersonaliId: TIntegerField
      FieldName = 'iId'
      Required = True
    end
    object zq_RegimenesPersonaliCodigoSAT: TIntegerField
      FieldName = 'iCodigoSAT'
    end
    object zq_RegimenesPersonalsDescripcion: TStringField
      FieldName = 'sDescripcion'
      Size = 255
    end
  end
