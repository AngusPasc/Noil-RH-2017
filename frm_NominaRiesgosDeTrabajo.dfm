object frmNominaRiesgosDeTrabajo: TfrmNominaRiesgosDeTrabajo
  Left = 0
  Top = 0
  ...
  object grid_Comunidades: TDBGrid
    ...
    Color = clWhite
    Ctl3D = False
    DataSource = ds_RiesgosDeTrabajo
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -11
    Font.Name = 'Arial'
  ...
  object ds_RiesgosDeTrabajo: TDataSource
    AutoEdit = False
    DataSet = zq_RiesgosDeTrabajo
    Left = 115
    Top = 49
  end
  object zq_RiesgosDeTrabajo: TZQuery
    Connection = connection.zConnection
    SQL.Strings = (
      'SELECT * FROM nom_catalogoderiesgos;')
    Params = <>
    Left = 80
    Top = 48
    object zq_RiesgosDeTrabajoiId: TIntegerField
      FieldName = 'iId'
      Required = True
    end
    object zq_RiesgosDeTrabajoiCodigoSAT: TIntegerField
      FieldName = 'iCodigoSAT'
    end
    object zq_RiesgosDeTrabajosDescripcion: TStringField
      FieldName = 'sDescripcion'
      Size = 255
    end
  end
