...
begin
  ...
  Try
    ...
    if (Length(Qry.FieldValues['sRFC'])<>12) Or (Length(Qry.FieldValues['sRFC'])<>13) then
       begin
    ...
    if (Length(qryCompanias.FieldValues['sRFC'])<>12) Or (Length(qryCompanias.FieldValues['sRFC'])<>13) then
       begin
